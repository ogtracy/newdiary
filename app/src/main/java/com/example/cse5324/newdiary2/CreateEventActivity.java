...
public class CreateEventActivity extends AppCompatActivity
        ...
        SearchDialog.AddNoteListener, MyListAdapter.MyListAdapterListener, AdapterView.OnItemClickListener {
    ...
    private void getViews()
    {
        ...
        location.setAdapter(new GooglePlacesAutocompleteAdapter(this, R.layout.list_item));
